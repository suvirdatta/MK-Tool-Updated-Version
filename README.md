...
### 1- Download and Run
To use this tool, simply download the app from the [releases page (Download)](https://github.com/suvirdatta/SD-PUBG-Mobile-Tool/releases) and run it on your PC. Follow the on-screen instructions to change the graphics settings, optimize Gameloop and PC, or create a desktop shortcut for PUBG Mobile.
...
![SD PUBG Mobile Tool screenshot](./images/sd-pubg-mobile-tool.png)
![SD PUBG Mobile Tool Optimize screenshot](./images/sd-pubg-mobile-tool-optimize.png)
